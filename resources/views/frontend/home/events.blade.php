    ...
    <div class="container" data-aos="fade-up" data-aos-delay="100">
        ...
        <div class="row g-4">
            ...
            <div class="col-lg-4 col-md-6" data-aos="zoom-in" data-aos-delay="200">
                <div class="event-item">
                    <div class="event-image">
                        <img src="{{ asset('') }}assets/frontend/img/education/events-3.webp" alt="Workshop" class="img-fluid">
            ...
            <div class="col-lg-4 col-md-6" data-aos="zoom-in" data-aos-delay="300">
                <div class="event-item">
                    <div class="event-image">
                        <img src="{{ asset('') }}assets/frontend/img/education/events-5.webp" alt="Tournament" class="img-fluid">
                        <div class="event-date-overlay">
            ...
            <div class="col-lg-4 col-md-6" data-aos="zoom-in" data-aos-delay="400">
                <div class="event-item">
                    <div class="event-image">
                        <img src="{{ asset('') }}assets/frontend/img/education/events-7.webp" alt="Art Exhibition" class="img-fluid">
                        <div class="event-date-overlay">
            ...
            <div class="col-lg-4 col-md-6" data-aos="zoom-in" data-aos-delay="200">
                <div class="event-item">
                    <div class="event-image">
                        <img src="{{ asset('') }}assets/frontend/img/education/events-2.webp" alt="Science Fair" class="img-fluid">
                        <div class="event-date-overlay">
            ...
            <div class="col-lg-4 col-md-6" data-aos="zoom-in" data-aos-delay="300">
                <div class="event-item">
                    <div class="event-image">
                        <img src="{{ asset('') }}assets/frontend/img/education/events-8.webp" alt="Community Event" class="img-fluid">
                        <div class="event-date-overlay">
            ...
            <div class="col-lg-4 col-md-6" data-aos="zoom-in" data-aos-delay="400">
                <div class="event-item">
                    <div class="event-image">
                        <img src="{{ asset('') }}assets/frontend/img/education/events-6.webp" alt="Music Concert" class="img-fluid">
                        <div class="event-date-overlay">
