<section id="why-us" class="section why-us light-background" data-builder="section">
      ...
      <div class="container-fluid">
        ...
        <div class="row gy-4">
          ...
          <div class="order-1 col-lg-5 order-lg-2 why-us-img">
            <img src="{{asset('')}}assets/frontend/img/why-us.png" class="img-fluid" alt="" data-aos="zoom-in" data-aos-delay="100">
          </div>
        </div>
      ...
      <div class="container" data-aos="fade-up" data-aos-delay="100">
        ...
        <div class="row gy-5">
          ...
          <div class="col-lg-4" data-aos="fade-up" data-aos-delay="200">
            <div class="steps-item">
              <div class="steps-image">
                <img src="{{asset('')}}assets/frontend/img/steps/steps-1.webp" alt="Step 1" class="img-fluid" loading="lazy">
              </div>
          ...
          <div class="col-lg-4" data-aos="fade-up" data-aos-delay="300">
            <div class="steps-item">
              <div class="steps-image">
                <img src="{{asset('')}}assets/frontend/img/steps/steps-2.webp" alt="Step 2" class="img-fluid" loading="lazy">
              </div>
              <div class="steps-content">
          ...
          <div class="col-lg-4" data-aos="fade-up" data-aos-delay="400">
            <div class="steps-item">
              <div class="steps-image">
                <img src="{{asset('')}}assets/frontend/img/steps/steps-3.webp" alt="Step 3" class="img-fluid" loading="lazy">
              </div>
              <div class="steps-content">
    ...
    <section id="call-to-action" class="call-to-action section dark-background">
      ...
      <div class="container">
        ...
        <div class="row" data-aos="zoom-in" data-aos-delay="100">
          <div class="text-center col-xl-9 text-xl-start">
            <h3>Call To Action</h3>
            <p>Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.</p>
          </div>
          <div class="text-center col-xl-3 cta-btn-container">
        ...
        <div class="row gy-4">
          ...
          <div class="col-lg-6" data-aos="fade-up" data-aos-delay="100">
            <div class="team-member d-flex align-items-start">
              <div class="pic"><img src="{{asset('')}}assets/frontend/img/person/person-m-7.webp" class="img-fluid" alt=""></div>
          ...
          <div class="col-lg-6" data-aos="fade-up" data-aos-delay="200">
            <div class="team-member d-flex align-items-start">
              <div class="pic"><img src="{{asset('')}}assets/frontend/img/person/person-f-8.webp" class="img-fluid" alt=""></div>
              <div class="member-info">
                <h4>Sarah Jhonson</h4>
          ...
          <div class="col-lg-6" data-aos="fade-up" data-aos-delay="300">
            <div class="team-member d-flex align-items-start">
              <div class="pic"><img src="{{asset('')}}assets/frontend/img/person/person-m-6.webp" class="img-fluid" alt=""></div>
              <div class="member-info">
          ...
          <div class="col-lg-6" data-aos="fade-up" data-aos-delay="400">
            <div class="team-member d-flex align-items-start">
              <div class="pic"><img src="{{asset('')}}assets/frontend/img/person/person-f-4.webp" class="img-fluid" alt=""></div>
              <div class="member-info">
                <h4>Amanda Jepson</h4>
          ...
          <div class="swiper-wrapper">
            ...
            <div class="swiper-slide">
              <div class="testimonial-item">
                <img src="{{asset('')}}assets/frontend/img/person/person-m-9.webp" class="testimonial-img" alt="">
                <h3>Saul Goodman</h3>
                <h4>Ceo &amp; Founder</h4>
                <div class="stars">
            ...
            <div class="swiper-slide">
              <div class="testimonial-item">
                <img src="{{asset('')}}assets/frontend/img/person/person-f-5.webp" class="testimonial-img" alt="">
                <h3>Sara Wilsson</h3>
                <h4>Designer</h4>
                <div class="stars">
                  <i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i>
            ...
            <div class="swiper-slide">
              <div class="testimonial-item">
                <img src="{{asset('')}}assets/frontend/img/person/person-f-12.webp" class="testimonial-img" alt="">
                <h3>Jena Karlis</h3>
                <h4>Store Owner</h4>
                <div class="stars">
                  <i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i>
            ...
            <div class="swiper-slide">
              <div class="testimonial-item">
                <img src="{{asset('')}}assets/frontend/img/person/person-m-12.webp" class="testimonial-img" alt="">
                <h3>Matt Brandon</h3>
                <h4>Freelancer</h4>
                <div class="stars">
                  <i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i>
            ...
            <div class="swiper-slide">
              <div class="testimonial-item">
                <img src="{{asset('')}}assets/frontend/img/person/person-m-13.webp" class="testimonial-img" alt="">
                <h3>John Larson</h3>
                <h4>Entrepreneur</h4>
                <div class="stars">
                  <i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i>
        ...
        <div class="row gy-5">
          ...
          <div class="col-xl-4 col-md-6">
            <div class="post-item position-relative h-100" data-aos="fade-up" data-aos-delay="100">
              ...
              <div class="overflow-hidden post-img position-relative">
                <img src="{{asset('')}}assets/frontend/img/blog/blog-post-1.webp" class="img-fluid" alt="">
          ...
          <div class="col-xl-4 col-md-6">
            <div class="post-item position-relative h-100" data-aos="fade-up" data-aos-delay="200">
              ...
              <div class="overflow-hidden post-img position-relative">
                <img src="{{asset('')}}assets/frontend/img/blog/blog-post-2.webp" class="img-fluid" alt="">
          ...
          <div class="col-xl-4 col-md-6" data-aos="fade-up" data-aos-delay="300">
            <div class="post-item position-relative h-100">
              ...
              <div class="overflow-hidden post-img position-relative">
                <img src="{{asset('')}}assets/frontend/img/blog/blog-post-3.webp" class="img-fluid" alt="">
