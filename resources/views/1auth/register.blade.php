    ...
    <x-authentication-card>
        ...
        <form method="POST" action="{{ route('register') }}">
            ...
            <div class="mt-4">
                ...
                <x-input id="celuller_no" class="block w-full mt-1" type="number" name="celuller_no" :value="old('celuller_no')" required autofocus autocomplete="celuller_no" />
            </div>

            <div class="mt-4">
                <x-label for="password" value="{{ __('Password') }}" />
                <x-input id="password" class="block w-full mt-1" type="password" name="password" required autocomplete="new-password" />
                <small class="text-muted">Min 8 caracter, min 1 symbol, min 1 Uppercase</small>
