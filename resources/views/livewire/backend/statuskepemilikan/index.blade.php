            ...
            <div class="col-xl-12 col-md-12 col-lg-12 col-12">
                <div class="box box-bordered border-primary">
                    ...
                    <div class="box-body">
                        ...
                        <div class="row">
                            <div class="col-xl-12 col-md-12 col-lg-12 col-12">
                                @if ($datastatuskepemilikan->count())
                                <div class="table-responsive">
                                    <table class="table mb-0 table-hover">
                                        ...
                                        <tbody>
                                            @foreach ($datastatuskepemilikan as $no =>  $item)
                                            <tr class="@if ($this->isChecked($item->agamaid))
                                                table-primary
                                                @endif">
                                                <th class="text-right" scope="row">{{ $no + $datastatuskepemilikan->firstItem() }}</th>
                                                <td>
                                                    {{ !empty($item->sort_kepemilikan) ? $item->sort_kepemilikan:'' }}<br/>
                                                </td>
                                                <td>
                                ...
                                <div class="mt-3 row">
                                    <div class="col-xl-12 col-md-12 col-lg-12 col-12 ">
                                        @if ($datastatuskepemilikan->total() > 10)
                                        {{ $datastatuskepemilikan->links() }}
                                        @else
                                        Page : {{ $datastatuskepemilikan->currentPage() }} | Show {{ $datastatuskepemilikan->count() }} data
                                        of {{ $datastatuskepemilikan->total() }}
                                        @endif
                                    </div>
