                            ...
                            <div class="col-xl-12 col-md-12 col-lg-12 col-12">
                                ...
                                <div class="table-responsive">
                                    <table class="table mb-0 table-hover">
                                        ...
                                        <tbody>
                                            @foreach ($databentukpendidikan as $no =>  $item)
                                            <tr class="@if ($this->isChecked($item->agamaid))
                                                table-primary
                                                @endif">
                                                <th class="text-right" scope="row">{{ $no + $databentukpendidikan->firstItem() }}</th>
                                                <td>
                                ...
                                <div class="mt-3 row">
                                    <div class="col-xl-12 col-md-12 col-lg-12 col-12 ">
                                        @if ($databentukpendidikan->total() > 10)
                                        {{ $databentukpendidikan->links() }}
                                        @else
                                        Page : {{ $databentukpendidikan->currentPage() }} | Show {{ $databentukpendidikan->count() }} data
                                        of {{ $databentukpendidikan->total() }}
                                        @endif
                                    </div>
