                                ...
                                <div class="col-xl-12 col-md-12 col-lg-12 col-12">
                                    ...
                                    <div class="table-responsive">
                                        <table class="table mb-0 table-hover">
                                            ...
                                            <tbody>
                                                @foreach ($datamatapelajaran as $no =>  $item)
                                                <tr>
                                                    <th class="text-right" scope="row">{{ $no + $datamatapelajaran->firstItem() }}</th>
                                                    {{-- <td>
                                    ...
                                    <div class="mt-3 row">
                                        <div class="col-xl-12 col-md-12 col-lg-12 col-12 ">
                                            @if ($datamatapelajaran->total() > 10)
                                            {{ $datamatapelajaran->links() }}
                                            @else
                                            Page : {{ $datamatapelajaran->currentPage() }} | Show {{ $datamatapelajaran->count() }} data
                                            of {{ $datamatapelajaran->total() }}
                                            @endif
                                        </div>
