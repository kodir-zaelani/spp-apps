                                ...
                                <div class="col-xl-12 col-md-12 col-lg-12 col-12">
                                    ...
                                    <div class="table-responsive">
                                        <table class="table mb-0 table-hover">
                                            ...
                                            <tbody>
                                                @foreach ($datakurikulum as $no =>  $item)
                                                <tr>
                                                    <th class="text-right" scope="row">{{ $no + $datakurikulum->firstItem() }}</th>
                                                    <td>
                                                        {{ !empty($item->nama_kurikulum) ? $item->nama_kurikulum:'' }}
                                                    </td>
                                                    <td>
                                                        {{-- {{ !empty($item->mulai_berlaku) ? $item->mulai_berlaku:'' }} --}}
                                                        {{ TanggalID('j M Y', $item->mulai_berlaku) }}
                                                    </td>
                                                    <td>
                                                        {{ !empty($item->sistem_sks) ? $item->sistem_sks:'' }}
                                                    </td>
                                                    <td>
                                                        {{ !empty($item->total_sks) ? $item->total_sks:'' }}
                                                    </td>
                                                </tr>
                                                @endforeach
                                    ...
                                    <div class="mt-3 row">
                                        <div class="col-xl-12 col-md-12 col-lg-12 col-12 ">
                                            @if ($datakurikulum->total() > 10)
                                            {{ $datakurikulum->links() }}
                                            @else
                                            Page : {{ $datakurikulum->currentPage() }} | Show {{ $datakurikulum->count() }} data
                                            of {{ $datakurikulum->total() }}
                                            @endif
                                        </div>
