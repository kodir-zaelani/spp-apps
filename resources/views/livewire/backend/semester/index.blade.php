                                ...
                                <div class="col-xl-12 col-md-12 col-lg-12 col-12">
                                    ...
                                    <div class="table-responsive">
                                        <table class="table mb-0 table-hover">
                                            ...
                                            <tbody>
                                                @foreach ($datasemester as $no =>  $item)
                                                <tr>
                                                    ...
                                                    <td>
                                                        {{ !empty($item->semester) ? $item->semester:'' }}
                                                    </td>
                                                    <td>
                                                         {!! $item->periode !!}
                                                    </td>
                                                    <td>
                                                        {{ !empty($item->tanggal_mulai) ? $item->tanggal_mulai:'' }}
                                                    </td>
                                                    <td>
                                    ...
                                    <div class="mt-3 row">
                                        <div class="col-xl-12 col-md-12 col-lg-12 col-12 ">
                                            @if ($datasemester->total() > 10)
                                            {{ $datasemester->links() }}
                                            @else
                                            Page : {{ $datasemester->currentPage() }} | Show {{ $datasemester->count() }} data
                                            of {{ $datasemester->total() }}
                                            @endif
                                        </div>
