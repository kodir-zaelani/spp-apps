<div>
    <div class="box-header with-border">
        ...
        <div class="box-controls pull-right">
            <button  wire:click="canceladdtagihan" class="btn btn-warning btn-sm ms-auto" title="Add New"> Cancel</button>
        </div>
    </div>
    <div class="box-body">
        <form enctype="multipart/form-data" >
            <div class="box-body">
                ...
                <div class="form-group">
                    ...
                    <div class="controls">
                        <input type="number" wire:model="nama" class="form-control @error('nama') is-invalid @enderror" value="{{ old('nama') }}" placeholder="Besaran" required>
                    </div>
                    @error('nama')
