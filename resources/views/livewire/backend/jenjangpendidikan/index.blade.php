                    ...
                    <div class="box-body">
                        ...
                        <div class="row">
                            <div class="col-xl-12 col-md-12 col-lg-12 col-12">
                                    ...
                                    <table class="table mb-0 table-hover">
                                        ...
                                        <tbody>
                                            ...
                                            <tr class="@if ($this->isChecked($item->agamaid))
                                                ...
                                                <td>
                                                    {{ !empty($item->jenjang_lembaga) ? $item->jenjang_lembaga:'' }}<br/>
                                                </td>
                                                <td>
                                                    {{ !empty($item->jenjang_orang) ? $item->jenjang_orang:'' }}<br/>
                                                </td>
                                            </tr>
                                            @endforeach
                                ...
                                <div class="mt-3 row">
                                    <div class="col-xl-12 col-md-12 col-lg-12 col-12 ">
                                        @if ($datajenjangpendidikan->total() > 10)
                                        {{ $datajenjangpendidikan->links() }}
                                        @else
                                        Page : {{ $datajenjangpendidikan->currentPage() }} | Show {{ $datajenjangpendidikan->count() }} data
                                        of {{ $datajenjangpendidikan->total() }}
                                        @endif
                                    </div>
