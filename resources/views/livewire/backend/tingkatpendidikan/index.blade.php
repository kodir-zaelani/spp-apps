            ...
            <div class="col-xl-12 col-md-12 col-lg-12 col-12">
                <div class="box box-bordered border-primary">
                    ...
                    <div class="box-body">
                        ...
                        <div class="row">
                            <div class="col-xl-12 col-md-12 col-lg-12 col-12">
                                @if ($datatingkatpendidikan->count())
                                <div class="table-responsive">
                                    <table class="table mb-0 table-hover">
                                        ...
                                        <tbody>
                                            @foreach ($datatingkatpendidikan as $no =>  $item)
                                            <tr class="@if ($this->isChecked($item->agamaid))
                                                table-primary
                                                @endif">
                                                <th class="text-right" scope="row">{{ $no + $datatingkatpendidikan->firstItem() }}</th>
                                                <td>
                                                    {{ !empty($item->kode) ? $item->kode:'' }}<br/>
                                                </td>
                                                <td>
                                                    {{ !empty($item->nama) ? $item->nama:'' }}<br/>
                                                </td>
                                                <td>
                                                    {{ !empty($item->jenjangpendidikan_id) ? $item->jenjangpendidikan->nama:'' }}<br/>
                                                </td>
                                            </tr>
                                            @endforeach
                                ...
                                <div class="mt-3 row">
                                    <div class="col-xl-12 col-md-12 col-lg-12 col-12 ">
                                        @if ($datatingkatpendidikan->total() > 10)
                                        {{ $datatingkatpendidikan->links() }}
                                        @else
                                        Page : {{ $datatingkatpendidikan->currentPage() }} | Show {{ $datatingkatpendidikan->count() }} data
                                        of {{ $datatingkatpendidikan->total() }}
                                        @endif
                                    </div>
