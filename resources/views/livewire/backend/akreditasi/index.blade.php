                                ...
                                <div class="col-xl-12 col-md-12 col-lg-12 col-12">
                                    ...
                                    <div class="table-responsive">
                                        <table class="table mb-0 table-hover">
                                            ...
                                            <tbody>
                                                @foreach ($dataakreditasi as $no =>  $item)
                                                <tr class="@if ($this->isChecked($item->agamaid))
                                                table-primary
                                                @endif">
                                                    <th class="text-right" scope="row">{{ $no + $dataakreditasi->firstItem() }}</th>
                                                    <td>
                                    ...
                                    <div class="mt-3 row">
                                        <div class="col-xl-12 col-md-12 col-lg-12 col-12 ">
                                            @if ($dataakreditasi->total() > 10)
                                            {{ $dataakreditasi->links() }}
                                            @else
                                            Page : {{ $dataakreditasi->currentPage() }} | Show {{ $dataakreditasi->count() }} data
                                            of {{ $dataakreditasi->total() }}
                                            @endif
                                        </div>
