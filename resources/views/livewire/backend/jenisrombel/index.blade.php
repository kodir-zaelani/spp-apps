                                ...
                                <div class="col-xl-12 col-md-12 col-lg-12 col-12">
                                    ...
                                    <div class="table-responsive">
                                        <table class="table mb-0 table-hover">
                                            ...
                                            <tbody>
                                                @foreach ($datajenisrombel as $no =>  $item)
                                                <tr class="@if ($this->isChecked($item->agamaid))
                                                table-primary
                                                @endif">
                                                    <th class="text-right" scope="row">{{ $no + $datajenisrombel->firstItem() }}</th>
                                                    <td>
                                    ...
                                    <div class="mt-3 row">
                                        <div class="col-xl-12 col-md-12 col-lg-12 col-12 ">
                                            @if ($datajenisrombel->total() > 10)
                                            {{ $datajenisrombel->links() }}
                                            @else
                                            Page : {{ $datajenisrombel->currentPage() }} | Show {{ $datajenisrombel->count() }} data
                                            of {{ $datajenisrombel->total() }}
                                            @endif
                                        </div>
