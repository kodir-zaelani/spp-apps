<x-form-section submit="updateProfileInformation">
    ...
    <x-slot name="form">
        ...
        <div class="col-span-6 sm:col-span-4">
            <x-label for="celuller_no" value="{{ __('Phone Number') }}" />
            <x-input id="celuller_no" type="text" class="block w-full mt-1" wire:model="state.celuller_no" required autocomplete="celuller_no" />
            <x-input-error for="celuller_no" class="mt-2" />
        </div>
        <div class="col-span-6 sm:col-span-4">
            <x-label for="displayname" value="{{ __('Display Name') }}" />
            <x-input id="displayname" type="text" class="block w-full mt-1" wire:model="state.displayname" required autocomplete="displayname" />
            <x-input-error for="displayname" class="mt-2" />
        </div>

        <!-- Email -->
        <div class="col-span-6 sm:col-span-4">
            <x-label for="email" value="{{ __('Email') }}" />
            <x-input id="email" type="email" class="block w-full mt-1" wire:model="state.email" required autocomplete="username" readonly/>
