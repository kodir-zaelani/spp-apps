                        ...
                        {{-- <form method="POST" action="{{ route('user.signup') }}"> --}}
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    @enderror
                                    <small><span class="mt-2 text-muted">Password must be 8 caracter, 1 Symbol, 1 Uppercase</span></small>
                                </div>
                            </div>
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-md-6">
                                    <input id="password-confirm" type="password" class="form-control" name="password_confirmation" required autocomplete="new-password" {{ old('password_confirmation') }}>
                                </div>
                            </div>
                            <div class="mb-3 row" hidden>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input id="roles" type="text" class="form-control" name="roles" value="admin" >
                                </div>
                            </div>
                            ...
                            <div class="mb-0 row">
                                <div class="col-md-6 offset-md-4">
                                    ...
                                    <a href="{{route('login')}}" class="ms-4 btn btn-info">
                                        {{ __('Sign in') }}
                                    </a>
                                </div>
                            </div>
