                                    ...
                                    <li class="nav-item"> <a class="nav-link active" data-bs-toggle="tab" href="#home7"
                                        ...
                                        <li class="nav-item"> <a class="nav-link" data-bs-toggle="tab" href="#messages7"
                                            ...
                                            <li class="nav-item"> <a class="nav-link" data-bs-toggle="tab" href="#logo7"
                                                role="tab"><span class="hidden-sm-up"><i class="ion-email"></i></span> <span
                                                class="hidden-xs-down">Logo</span></a> </li>
                                                <li class="nav-item"> <a class="nav-link" data-bs-toggle="tab" href="#maps7"
                                                    ...
                                                    <li class="nav-item"> <a class="nav-link" data-bs-toggle="tab" href="#meta9"
                                                        role="tab"><span class="hidden-sm-up"><i class="ion-email"></i></span> <span
                                                        class="hidden-xs-down">Meta Descriptions</span>
                                                    </a>
                                                </li>
                                            </ul>
                                                            ...
                                                            <div class="box-body">
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="controls">
                                                                        ...
                                                                        value="{{ old('webname') }}" placeholder="Web Title"
                                                                        required>
                                                                    </div>
                                                                    @error('webname')
                                                                    ...
                                                                    <div class="form-group">
                                                                        ...
                                                                        <div class="form-control-feedback"><small><code>Tagline situs bisa
                                                                            ...
                                                                            <div class="form-group">
                                                                                ...
                                                                                <div class="controls">
                                                                                    ...
                                                                                    value="{{ old('siteurl') }}" placeholder="Alamat website"
                                                                                    required>
                                                                                </div>
                                                                                <div class="form-control-feedback"><small><code>Alamat website
                                                                                </code> | contoh: http://www.digitalnusantara.id</small>
                                                                            </div>
                                                                            @error('siteurl')
                                                                            <div class="form-control-feedback"><small>
                                                                                <code>{{ $message }}</code> </small></div>
                                                                                        ...
                                                                                        <label class="form-label">Description <span
                                                                                            ...
                                                                                            <div class="form-group">
                                                                                                ...
                                                                                                <div class="controls">
                                                                                                    ...
                                                                                                    value="{{ old('streamer') }}" placeholder="Streamer"
                                                                                                    required>
                                                                                                </div>
                                                                                                <small>exp:
                                                                                            ...
                                                                                            <div class="box">
                                                                                                ...
                                                                                                <div class="box-body">
                                                                                                    <div class="form-group">
                                                                                                        <h5>Whatsapp </h5>
                                                                                                        <div class="controls">
                                                                                                            <input type="text" name="watshapp"
                                                                                                            class="form-control @error('watshapp') is-invalid @enderror"
                                                                                                            value="{{ old('watshapp') }}"
                                                                                                            placeholder="Nomor Whatsapp">
                                                                                                        </div>
                                                                                                        <div class="form-control-feedback"><small><code>Nomor
                                                                                                            Whatsapp</code></small></div>
                                                                                                            @error('watshapp')
                                                                                                            <div class="form-control-feedback"><small>
                                                                                                                <code>{{ $message }}</code> </small></div>
                                                                                                                @enderror
                                                                                                                    ...
                                                                                                                    <div class="form-group">
                                                                                                                        ...
                                                                                                                        <div class="form-control-feedback"><small><code> phone
                                                                                                                            ...
                                                                                                                            <div class="form-group">
                                                                                                                                ...
                                                                                                                                <div class="form-control-feedback"><small><code> Email
                                                                                                                                </code></small></div>
                                                                                                                                @error('email')
                                                                                                                                <div class="form-control-feedback"><small>
                                                                                                                                    <code>{{ $message }}</code> </small></div>
                                                                                                                                ...
                                                                                                                                <div class="form-group">
                                                                                                                                    ...
                                                                                                                                    <div class="form-group">
                                                                                                                                        ...
                                                                                                                                        <div class="form-control-feedback"><small><code> Kota
                                                                                                                                        </code></small></div>
                                                                                                                                        @error('city')
                                                                                                                                        <div class="form-control-feedback"><small>
                                                                                                                                            <code>{{ $message }}</code> </small></div>
                                                                                                                                        ...
                                                                                                                                        <div class="form-group">
                                                                                                                                            ...
                                                                                                                                            <div class="controls">
                                                                                                                                                ...
                                                                                                                                                value="{{ old('state') }}" placeholder=" Province">
                                                                                                                                            </div>
                                                                                                                                            ...
                                                                                                                                            <div class="form-group">
                                                                                                                                                ...
                                                                                                                                                <div class="form-control-feedback"><small><code> Negara
                                                                                                                                                </code></small></div>
                                                                                                                                                @error('country')
                                                                                                                                                <div class="form-control-feedback"><small>
                                                                                                                                                    <code>{{ $message }}</code> </small></div>
                                                                                                                                        ...
                                                                                                                                        <div class="box-body">
                                                                                                                                            <div class="form-group">
                                                                                                                                                ...
                                                                                                                                                <div class="controls">
                                                                                                                                                    ...
                                                                                                                                                    placeholder="maps">{{ old('maps') }} </textarea>
                                                                                                                                                </div>
                                                                                                                                            ...
                                                                                                                                            <div class="box-body">
                                                                                                                                                <div class="form-group">
                                                                                                                                                    ...
                                                                                                                                                    <div class="controls">
                                                                                                                                                        ...
                                                                                                                                                        class="form-control @error('meta_description') is-invalid @enderror" placeholder="meta_description">{{ old('meta_description') }} </textarea>
                                                                                                                                                    </div>
                                                                                                                                                ...
                                                                                                                                                <div class="box-body">
                                                                                                                                                    <div class="form-group">
                                                                                                                                                        ...
                                                                                                                                                        <div class="controls">
                                                                                                                                                            ...
                                                                                                                                                            placeholder="meta_keywords">{{ old('meta_keywords') }} </textarea>
                                                                                                                                                        </div>
                                                                                                                                                        <div class="form-control-feedback">
                                                                                                                                                            <small> Exp:
                                                                                                                                                                <code>
