    ...
    <div class="row">
        <div class="col-xl-12 col-md-12 col-lg-12 col-12">
            <div class="box box-bordered border-primary">
                ...
                <div class="box-body">
                    <form id="post-form" enctype="multipart/form-data" action="{{ route('backend.users.store') }}"
                    method="post">
                    @csrf
                    <div class="row">
                        <div class="col-xl-12 col-md-12 col-lg-12 col-12">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input name="celuller_no" type="text" value="{{ old('celuller_no') }}"
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                <label class="font-weight-bold">ROLE : <span
                                    ...
                                    <div class="form-check form-check-inline @error('roles') is-invalid @enderror">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label for="password">Generate Password:  <span class="text-danger">Sukses12!</span></label>
                            ...
                            {{-- <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    placeholder="Enter a user password confirmation">
