...
class Profile extends Component
{
    ...
    public function mount()
    {
        ...
        $this->prevUsername            = $model->username;
    ...
    public function changeimage()
    {
        ...
        if (!empty($this->image)) {
            ...
            $imagedata = $manager->read('uploads/images/users/'.$imageHashName)->resize(120, 100); // Jangan lupa sesauikan nama folder dengan public folder image
        ...
        if(count($data)) {
            ...
            // Cleanup Tempeorary file livewire-temp
